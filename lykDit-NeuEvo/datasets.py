...
from datasets_utils import dvs_channel_check_expend, rescale
...
def get_dvsc10_data(batch_size, step, root=DATA_DIR, **kwargs):
    ...
    #修改的部分
    mix_up_enabled = mix_up > 0.0
    cut_mix_enabled = cut_mix > 0.0
    event_mix_enabled = event_mix > 0.0

    mixup_active = cut_mix_enabled | event_mix_enabled | mix_up_enabled
